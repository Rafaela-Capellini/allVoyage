...
export default function NacionalScreen(props) {
    return (
        ...
        <ScrollView>
            ...
            <View style={styles.menu}>
                ...
                <TouchableOpacity style={styles.button}>
                    <Text style={styles.buttonNac} onPress={() => props.navigation.navigate('Internacional')}>Internacional</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.button}>
